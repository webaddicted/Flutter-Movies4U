...
//    {END MOVIE DETAILS PAGE API}
  ...
  fetchNowPlaying() async {
    ...
    notifyListeners();
    _nowPlayingRespo =
        await _movieRepo.fetchNowPlaying(endPoint: ApiConstant.nowPlaying);
    notifyListeners();
  }
  ...
  fetchPopularMovie(int page) async {
    ...
    // notifyListeners();
    _popularMovieRespo =
        await _movieRepo.fetchNowPlaying(endPoint: ApiConstant.popularMovies, page: page);
    notifyListeners();
  }
  ...
  trandingMovie(int page) async {
    ...
    _trandingMovieRespo = await _movieRepo.fetchNowPlaying(
        endPoint: ApiConstant.trendingMovieList, page: page);
    notifyListeners();
  }
  ...
  discoverMovie(int page) async {
    ...
    // notifyListeners();
    _discoverMovieRespo =
        await _movieRepo.fetchNowPlaying(endPoint: ApiConstant.discoverMovie, page: page);
    notifyListeners();
  }
  ...
  upcommingMovie(int page) async {
    ...
    _upcommingMovieRespo =
        await _movieRepo.fetchNowPlaying(endPoint: ApiConstant.upcomingMovie, page: page);
    notifyListeners();
  }
  ...
  topRatedMovie(int page) async {
    ...
    // notifyListeners();
    _topRatedMovieRespo =
        await _movieRepo.fetchNowPlaying(endPoint: ApiConstant.topRated, page: page);
    notifyListeners();
  }
  ...
  fetchRecommendMovie(int movieId,int page) async {
    ...
    _recommendMovieRespo = await _movieRepo.fetchNowPlaying(
        endPoint: ApiConstant.movieDetails +
            movieId.toString() +
            ApiConstant.recommendationsMovie, page: page);
    notifyListeners();
  }
  ...
  fetchSimilarMovie(int movieId,int page) async {
    ...
    _similarMovieRespo = await _movieRepo.fetchNowPlaying(
        endPoint: ApiConstant.movieDetails +
            movieId.toString() +
            ApiConstant.similarMovies, page: page);
    notifyListeners();
  }
  ...
  fetchKeywordMovieList(int keywordId, int page) async {
    ...
    _keywordMovieListRespo = await _movieRepo.fetchNowPlaying(
        endPoint: ApiConstant.keywordsMovieList +
            keywordId.toString() +
            ApiConstant.keywordsApiMovies, page: page);
    notifyListeners();
  }
  ...
  searchMovies(String query, int page, bool clearList) async {
